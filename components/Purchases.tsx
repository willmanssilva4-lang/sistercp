        ...
        <div className="p-6 h-full flex flex-col">
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex flex-col gap-2 items-end">
                    <button
                        ...
                        className="bg-white border border-emerald-200 text-emerald-700 hover:bg-emerald-50 px-4 py-2 rounded-lg flex items-center gap-2 font-bold shadow-sm transition-all"
                    >
                        <TrendingUp size={20} />
                        Sugestão de Compras
                    </button>
            ...
            {activeTab === 'NEW_PURCHASE' ? (
                <div className="flex gap-6 h-full overflow-hidden">
                    ...
                    {/* RIGHT: Cart Items */}
                    <div className="w-1/2 flex flex-col bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
