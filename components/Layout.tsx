...
import { LayoutDashboard, ShoppingCart, Package, Users, Settings, LogOut, Store, ArrowLeftCircle, Truck, Gift, BarChart3, Layers, DollarSign, TrendingUp, Database, AlertTriangle, History, Menu, X } from 'lucide-react';
...
const Layout: React.FC<LayoutProps> = ({ children, currentView, onChangeView, onLogout, userName, userRole }) => {
  ...
  const allMenuItems = [
    ...
    { id: 'purchase-suggestion', label: 'Sugestão de Compra', icon: TrendingUp, roles: [UserRole.ADMIN, UserRole.MANAGER, UserRole.STOCKIST] },
    { id: 'peps', label: 'Lotes PEPS', icon: Layers, roles: [UserRole.ADMIN, UserRole.MANAGER, UserRole.STOCKIST] },
    ...
    { id: 'advanced-reports', label: 'Relatórios Avançados', icon: TrendingUp, roles: [UserRole.ADMIN, UserRole.MANAGER] },
    { id: 'profit-margin', label: 'Margem de Lucro', icon: TrendingUp, roles: [UserRole.ADMIN, UserRole.MANAGER] },
    { id: 'customers', label: 'Clientes', icon: Users, roles: [UserRole.ADMIN, UserRole.MANAGER, UserRole.CASHIER] },
    { id: 'customer-history', label: 'Histórico de Clientes', icon: History, roles: [UserRole.ADMIN, UserRole.MANAGER] },
    ...
    { id: 'backup', label: 'Backup', icon: Database, roles: [UserRole.ADMIN] },
